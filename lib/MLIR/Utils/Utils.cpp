...
std::optional<mlir::OperandRange> mlir::trscd::getIndicesIfMemRefOp(
    mlir::Operation *op) {
...
bool mlir::trscd::areIndicesPerfectlyAligned(mlir::Operation *op1, 
    mlir::Operation *op2, mlir::scf::ForOp loop1, mlir::scf::ForOp loop2) {
  ...
  if (!indices1 || !indices2) return false;
